...
def color_mask(frame, hue, range):
  ...
  if hue >= 180-range:
    ...
    low_lower_limit = np.array([0, 50, 50], dtype=np.uint8)

    high_upper_limit = np.array([180, 255, 255], dtype=np.uint8)
    high_lower_limit = np.array([hue - range, 50, 50], dtype=np.uint8)
    ...
    high_upper_limit = np.array([180, 255, 255], dtype=np.uint8)
    high_lower_limit = np.array([high_remaining, 50, 50], dtype=np.uint8)
    ...
    lower_limit = np.array([hue - range, 50, 50], dtype=np.uint8)
